...
import type { CalendarBooking } from "../../types/CalendarBooking";
    ...
    <div className="rounded-xl border border-[#3A1A22] bg-[#241217] overflow-hidden">
      ...
      <div className="grid grid-cols-7">
        {days.map((day) => {
          ...
          const dayBookings = bookings.filter((b) => inRange(dayKey, b.fromDate, b.toDate));
          ...
          return (
            ...
            >
              <span className="text-xs text-[#F5DEB3]/50">{format(day, "d")}</span>
